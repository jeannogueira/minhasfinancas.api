package com.jfontes.minhasfinancas.api.resource;
...
import com.jfontes.minhasfinancas.api.dto.AtualizaStatusDTO;
import com.jfontes.minhasfinancas.api.dto.LancamentoDTO;
...
import com.jfontes.minhasfinancas.model.enums.TipoLancamento;
import com.jfontes.minhasfinancas.service.LancamentoService;
	...
	public ResponseEntity atualizaStatus(@PathVariable("id") Long id, @RequestBody AtualizaStatusDTO dto) {
		return service.obterPorId(id).map(entity -> {
			...
			if(statusSelecionado == null) {
				return ResponseEntity.badRequest().body("Não foi possivel atuaçizar o status do Lancamento, envie um status válido" );
			}
			try {
